<script>
  ...
  onMount(() => {
      document.title="Margin Call Price when Short Selling Calculator"
  });
  let inputs = [
...
<svelte:head>
  <title>Margin Call Price when Short Selling Calculator - FinanceStudent.net</title>
...
<div class="cgrid">
  ...
  <div class="calcBox">
    <Calculator inputs = {inputs} resIcon = {resIcon} endpoint = "ShortMarginCallPrice" on:result = {formulaWriter}/>
  </div>
